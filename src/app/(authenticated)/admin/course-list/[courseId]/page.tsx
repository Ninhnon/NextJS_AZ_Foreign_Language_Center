...
export default function page() {
  ...
  const tt = {
    title: 'TT',
    start: new Date('2023-11-11T12:30:00').toISOString(),
    allDay: true,
    id: 1,
    eventColor: 'green',
  };
  ...
  useEffect(() => {
    // Call setAllEvents in response to an event or asynchronously
    setAllEvents([tt]);
  }, []);
  ...
  return (
    <div className="flex flex-col w-full h-full py-6 px-32">
      ...
      <main className="flex min-h-screen w-full flex-col items-center justify-between px-16 h-fit ">
